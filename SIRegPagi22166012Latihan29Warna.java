...
public class SIRegPagi22166012Latihan29Warna {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\u001b[31mYUK \u001b[32mCEK "
                  + "\u001b[33mKEPRIBADIANMU \u001b[36mDARI \u001b[35mWARNA \u001b[34mFAVORITMU \u001b[0m \n");
        ...
        switch (warna.toLowerCase()) {
            case "merah":
                deskripsiKepribadian = "\u001B[31m 1. Periang\n\u001B[0m \u001B[32m2. Pemberani\n"
                        ...
                        + "\u001B[0m \u001B[33m7. Memiliki energi kehangatan dan cinta.";
                break;
            case "hijau":
                deskripsiKepribadian = "\u001B[31m 1. Romantis\n\u001B[0m \u001B[32m2. Menyukai hal yang berbau alami dan keindahan\n"
                        ...
                        + "\u001B[0m \u001B[32m7. Menjunjung tinggi suatu nilai toleransi dan kepercayaan.";
                break;
            case "kuning":
                deskripsiKepribadian = "\u001B[31m 1. Optimis\n\u001B[0m \u001B[32m2. Suka bergaul\n"
                        ...
                        + "\u001B[0m \u001B[37m7. Royal\n" 
                        + "\u001B[0m \u001B[31m8. Hangat\n "
                        + "\u001B[0m\u001B[32m9. Meskipun karakternya optimis dan idealis,seringkali goyah dan tidak stabil\n"
                        + "\u001B[0m \u001B[33m10.Cenderung penakut";
                break;
            case "biru":
                deskripsiKepribadian = "\u001B[31m 1. Menyenangkan\n\u001B[0m \u001B[32m2. Bijaksana\n"
                        ...
                        + "\u001B[0m \u001B[36m6. Bersahabat\n"
                        + "\u001B[0m \u001B[31m7. Tidak terlalu suka menjadi sorotan banyak orang\n"
                        + "\u001B[0m \u001B[31m8. Menyembunyikan perasaan karena karakternya yang cenderung mencari jalan damai.";
                break;
            case "ungu":
                deskripsiKepribadian = "\u001B[31m 1. Optimis\n\u001B[0m \u001B[32m2. Tidak Pernah Ragu\n"
                        ...
                        + "\u001B[0m \u001B[31m7. Terkadang bersikap keras kepala dan angkuh.";
                break;
            default:
